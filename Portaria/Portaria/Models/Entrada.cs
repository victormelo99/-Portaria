...
namespace Portaria.Models
{
    public class Entrada
    {
        ...
        public Entrada(int id, int matricula, string tipo, string situacao, string nome, string identidade, string placa, string veiculo, 
            string cidade, string uf, string empresa, DateTime dataSaida)
        {
            Id = id;
            Matricula = matricula;
            Tipo = tipo;
